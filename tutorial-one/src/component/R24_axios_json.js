...
const Axios_JSON = () => {
    return (
        <>
            ...
            <h3>JSON</h3>
            <pre>
                JSON : JavaScript Objdect Notation
                       JavaScript 자바 스크립트
                       Object     객체
                       Notation   표기법
                ...
                {/*
                    ...
                    ...
                */}
                개발자들이 서버에서 가져온 값을 화면에 보여주기 위해 임시 데이터 json 을 사용해서 표현
                ...
                대표적으로 posts, comments, albums, photos, todos, users 가 존재
            ...
            <h3>비동기처리</h3>
            Ajax     : 자바스크립트를 이용해서 서버와 비동기적으로 데이터를 교환 FetchAPI 를 사용
            ...
            프로젝트를 진행하기 위해 axios 를 설치
            
            npm 과 yarn    - 구글스토어와 앱스토어의 차이 정도
